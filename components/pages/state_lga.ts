export const stateLGAs: Record<string, string[]> = {
  ...
  anambra: [
    "Aguata","Awka North","Awka South","Anambra East","Anambra West","Anaocha",
  ...
  kebbi: [
    "Aleiro","Arewa Dandi","Argungu","Bagudo","Birnin Kebbi","Bunza","Dandi","Fakai","Gwandu",
  ...
  lagos: [
    ...
    "Ifako-Ijaiye","Ikeja","Ikorodu","Kosofe","Lagos Island","Lagos Mainland","Mushin",
  ...
  ogun: [
    ...
    "Ifo","Ijebu East","Ijebu North","Ijebu North East","Ijebu Ode","Ikenne","Imeko Afon","Ipokia",
  ...
  osun: [
    ...
    "Egbedore","Ejigbo","Ife Central","Ife East","Ife North","Ife South","Ifelodun","Ila","Ilesa East","Ilesa West",
  ...
  sokoto: [
    "Binji","Bodinga","Dange Shuni","Gada","Goronyo","Gudu","Gwadabawa","Illela","Isa","Kware","Kebbe",
  ...
  zamfara: [
    "Anka","Bakura","Birnin Magaji","Bukkuyum","Bungudu","Gummi","Gusau","Kaura Namoda","Maradun",
